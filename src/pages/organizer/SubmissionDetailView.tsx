...
import { ArrowLeft, User, Code, CheckCircle, Clock, Zap, Brain, FileText, Target, Award } from 'lucide-react';
import type { SubmissionResponse } from '../../api/submissionService';

const SubmissionDetailView = () => {
  const location = useLocation();
  const navigate = useNavigate();
  const submission = location.state?.submission as SubmissionResponse;
  ...
  const aiFeedback = (submission as any).aiFeedback;
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div className="bg-theme-secondary rounded-xl p-6 shadow-lg border border-theme">
              <div className="flex items-center gap-3 mb-4">
                ...
                <div>
                  ...
                  <p className="text-lg font-bold text-theme-primary">{submission.username}</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-theme-secondary rounded-xl p-6 shadow-lg border border-theme">
              <div className="flex items-center gap-3 mb-4">
                <div className={`p-3 rounded-lg ${
                  submission.status === 'ACCEPTED' ? 'bg-green-500/10' :
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            {/* Judge Feedback */}
          {/* Judge Feedback (Final Clean Version — No numbers, no duplicate titles) */}
{submission.feedback && (
  <div className="bg-theme-secondary rounded-xl p-6 shadow-lg border border-theme border-l-4 border-l-blue-500">
    ...
    {(() => {
      ...
      const extractSection = (start: number, end?: number): string | undefined => {
        ...
        // Remove repeated section titles like "Correctness Summary Correctness Summary"
